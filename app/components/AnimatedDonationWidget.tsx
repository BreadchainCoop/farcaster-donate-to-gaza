...
export default function AnimatedDonationWidget() {
    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6">
          <h2 className="text-2xl font-bold text-white text-center">Donate to Gaza</h2>
          <p className="text-purple-100 text-sm text-center mt-1">100% goes directly to the family</p>
        </div>
